...
extern(C) @nogc nothrow {
    ...
    alias pblFontDataCreateFromLoader = BLResult function(BLFontDataCore* self, const(BLFontLoaderCore)* loader, uint faceIndex);
    ...
    alias pblFontDataInitFromLoader = BLResult function(BLFontDataCore* self, const(BLFontLoaderCore)* loader, uint faceIndex);
    alias pblFontDataListTags = BLResult function(const(BLFontDataCore)* self, BLArrayCore* dst);
    alias pblFontDataQueryTables = size_t function(const(BLFontDataCore)* self, BLFontTable* dst, const(BLTag)* tags, size_t count);
    ...
    alias pblFontFaceCreateFromLoader = BLResult function(BLFontFaceCore* self, const(BLFontLoaderCore)* loader, uint faceIndex);
    ...
    alias pblFontLoaderAssignMove = BLResult function(BLFontLoaderCore* self, BLFontLoaderCore* other);
    alias pblFontLoaderAssignWeak = BLResult function(BLFontLoaderCore* self, const(BLFontLoaderCore)* other);
    alias pblFontLoaderCreateFromData = BLResult function(BLFontLoaderCore* self, const(void)* data, size_t size, BLDestroyImplFunc destroyFunc, void* destroyData);
    alias pblFontLoaderCreateFromDataArray = BLResult function(BLFontLoaderCore* self, const(BLArrayCore)* dataArray);
    alias pblFontLoaderCreateFromFile = BLResult function(BLFontLoaderCore* self, const(char)* fileName, uint readFlags);
    alias pblFontLoaderEquals = bool function(const(BLFontLoaderCore)* a, const(BLFontLoaderCore)* b);
    alias pblFontLoaderInit = BLResult function(BLFontLoaderCore* self);
    alias pblFontLoaderReset = BLResult function(BLFontLoaderCore* self);
    ...
    alias pblPixelConverterCreate = BLResult function(BLPixelConverterCore* self, const(BLFormatInfo)* dstInfo, const(BLFormatInfo)* srcInfo);
    ...
    alias pblRandomReset = void function(BLRandom* self, ulong seed);
    ...
    alias pblRegionCombine = BLResult function(BLRegionCore* self, const(BLRegionCore)* a, const(BLRegionCore)* b, uint op);
    alias pblRegionCombineBB = BLResult function(BLRegionCore* self, const(BLBoxI)* a, const(BLBoxI)* b, uint op);
    alias pblRegionCombineBR = BLResult function(BLRegionCore* self, const(BLBoxI)* a, const(BLRegionCore)* b, uint op);
    alias pblRegionCombineRB = BLResult function(BLRegionCore* self, const(BLRegionCore)* a, const(BLBoxI)* b, uint op);
 ...
 __gshared {
    ...
    pblFontDataCreateFromLoader blFontDataCreateFromLoader;
    pblFontDataEquals blFontDataEquals;
    pblFontDataInit blFontDataInit;
    pblFontDataInitFromLoader blFontDataInitFromLoader;
    ...
    pblFontFaceCreateFromLoader blFontFaceCreateFromLoader;
    ...
    pblFontLoaderAssignMove blFontLoaderAssignMove;
    pblFontLoaderAssignWeak blFontLoaderAssignWeak;
    pblFontLoaderCreateFromData blFontLoaderCreateFromData;
    pblFontLoaderCreateFromDataArray blFontLoaderCreateFromDataArray;
    pblFontLoaderCreateFromFile blFontLoaderCreateFromFile;
    pblFontLoaderEquals blFontLoaderEquals;
    pblFontLoaderInit blFontLoaderInit;
    pblFontLoaderReset blFontLoaderReset;
...
Blend2DSupport loadBlend2D(const(char)* libName)
{
    ...
    lib.bindSymbol_stdcall(blFontDataCreateFromLoader, "blFontDataCreateFromLoader");
    lib.bindSymbol_stdcall(blFontDataEquals, "blFontDataEquals");
    lib.bindSymbol_stdcall(blFontDataInit, "blFontDataInit");
    lib.bindSymbol_stdcall(blFontDataInitFromLoader, "blFontDataInitFromLoader");
    ...
    lib.bindSymbol_stdcall(blFontFaceCreateFromLoader, "blFontFaceCreateFromLoader");
    ...
    lib.bindSymbol_stdcall(blFontLoaderAssignMove, "blFontLoaderAssignMove");
    lib.bindSymbol_stdcall(blFontLoaderAssignWeak, "blFontLoaderAssignWeak");
    lib.bindSymbol_stdcall(blFontLoaderCreateFromData, "blFontLoaderCreateFromData");
    lib.bindSymbol_stdcall(blFontLoaderCreateFromDataArray, "blFontLoaderCreateFromDataArray");
    lib.bindSymbol_stdcall(blFontLoaderCreateFromFile, "blFontLoaderCreateFromFile");
    lib.bindSymbol_stdcall(blFontLoaderEquals, "blFontLoaderEquals");
    lib.bindSymbol_stdcall(blFontLoaderInit, "blFontLoaderInit");
    lib.bindSymbol_stdcall(blFontLoaderReset, "blFontLoaderReset");
